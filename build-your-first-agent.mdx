...
Agents are powerful, but they can be tricky to get right. That's why we built [**human approvals**](/build-with-human-approvals). Human Approvals allows you to build powerful agents that automate your work, but configure them to ask for your approval before taking specific actions.
